 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://iface.service.jee.com.co/}personaVO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ListarPersonasResponse {
    ...
    protected List<PersonaVO> _return;
     ...
     * 
     */
    public List<PersonaVO> getReturn() {
        if (_return == null) {
            _return = new ArrayList<PersonaVO>();
        }
        return this._return;
    }
